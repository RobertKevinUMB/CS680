...
class DirectoryTest {
	...
	private String[] dirToStringArray(Directory d) {
		...
		String[] dirInfo = { Boolean.toString(d.isDirect()), d.getName(), Integer.toString(d.getSize()),
	...
	void testDirectory() {
		...
		assertTrue(home.isDirect());
		assertTrue(applications.isDirect());
		assertTrue(code.isDirect());
		assertFalse(a.isDirect());
		assertFalse(b.isDirect());
		assertFalse(c.isDirect());
		assertFalse(d.isDirect());
		assertFalse(e.isDirect());
		assertFalse(f.isDirect());	
	}
	...
	@Test
	public void testDirectEqualRoot() {
	...
	@Test
	public void testDirectEqualHome() {
	...
	@Test
	public void testDirectEqualApplications() {
	...
	@Test
	public void testDirectEqualCode() {
